...
import MuseumLogo from './M-01.svg';
    ...
    return (
        <form onSubmit={searchObjects} >
            <div className='flex flex-col my-5'>
                ...
                <input type="text" id="query" name="query" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-met focus:border-red-met block w-full ps-20 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-met dark:focus:border-red-met" placeholder={placeholder} value={query} onChange={(e) => setQuery(e.target.value)} required />
                    </div>
                    <button type="submit" className="p-2.5 ms-2 text-sm font-medium text-white bg-red-met rounded-lg border border-red-met hover:bg-red-met focus:ring-4 focus:outline-none focus:ring-red-met dark:bg-red-met dark:hover:bg-red-met dark:focus:ring-red-met">
