...
function DepartmentCard(props) {
    ...
    return (
        <div className="block flex flex-col max-w-sm m-2 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 basis-full sm:basis-1/2 md:basis-1/3">
            ...
            <Link to={`/department/${dpt.departmentId}`} state={ dpt.displayName } className='inline-flex font-medium text-red-met hover:underline pt-4'>
                ...
                <svg className="w-6 h-6 ms-2.5 rtl:rotate-[270deg]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M15 11v4.833A1.166 1.166 0 0 1 13.833 17H2.167A1.167 1.167 0 0 1 1 15.833V4.167A1.166 1.166 0 0 1 2.167 3h4.618m4.447-2H17v5.768M9.111 8.889l7.778-7.778" />
                </svg>
            </Link>
        </div>
    )
